...
const JSONTipo = { 0:'categories', 1:'meals' };

function callMealDBAPI(url, callType, jsonTipoEsperado = 1 ){
    document.getElementById('json').innerHTML = "<div><img width='300px' src='https://cdn.dribbble.com/users/1215152/screenshots/12858414/media/2899b4a569a01cdb3614b65e7f250092.gif'></div>";
