...
function callAPI() {
  // var foundYou = document.getElementById('searchInputTxtBox');
  // console.log('Valor del ElementByID',foundYou.value);
  // // console.log('Valor del ElementByID',foundYou.value);
...
function mealHTML(dataMeal) {
  return dataMeal.map(function (data) {
    ...
    return `${
      ...
      meal.strMeal +
      "</p>" +
      '<button class="linkCard" onclick="callMealDBAPI(\'https://www.themealdb.com/api/json/v1/1/lookup.php?i=' +
      meal.idMeal +
      "',callType,1)\">" +
      '<img class="imgCard" src="' +
      meal.strMealThumb +
...
//Llave v2/9973533/
//Se tienen 14 llamadas a la API.
//Las agrupamos en 2 por el tipo de OBJ regresado por el API en un JSON.
...
//2)
let listAllMealsx1stLetter =
  "https://www.themealdb.com/api/json/v1/1/search.php?f=k";
//3)
let searchMealxId =
  "https://www.themealdb.com/api/json/v1/1/lookup.php?i=52772"; // # Lookup full meal details by id
//4)
let searchSingleRandomMeal =
  "https://www.themealdb.com/api/json/v1/1/random.php"; // # Lookup a single random meal
//5)
let search10RandomMeals =
  "https://www.themealdb.com/api/json/v1/1/randomselection.php"; // # Lookup a selection of 10 random meals (only available to $2+ Paypal supporters)
//6)
...
//9)
let searchAllIngredients =
  "https://www.themealdb.com/api/json/v1/1/list.php?i=list"; //Los ID de ingrediente no son consecutivos algunos se saltan
//10)
let searchxMainIngredient =
  "https://www.themealdb.com/api/json/v1/1/ filter.php?i=chicken_breast";
//11)
let searchxMultiIngredient =
  "https://www.themealdb.com/api/json/ filter.php?i=garlic,salt";
//12)
let searchxCat =
